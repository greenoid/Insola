...
This document explains how to use the GitHub release pipeline for the Insola Game project.
...
4. Create two JAR files:
   - `Insola-{version}.jar` - Standard JAR
   - `Insola-{version}-jar-with-dependencies.jar` - Fat JAR with all dependencies
...
java -jar target/Insola-1.0-SNAPSHOT.jar

# Test the fat JAR (with dependencies)
java -jar target/Insola-1.0-SNAPSHOT-jar-with-dependencies.jar
```
